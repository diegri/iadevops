## Flame Graph with FastAPI App Example for IA Explain

Remix from: https://github.com/grafana/pyroscope/tree/main/examples/language-sdk-instrumentation/python
